...
- `picker-models.ts`, `picker-notes.ts` — `FuzzySuggestModal` subclasses for model picking and the full-vault `@`-mention picker (pins on select; see Composer for semantics).
